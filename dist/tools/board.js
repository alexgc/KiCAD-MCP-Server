...
export function registerBoardTools(server, callKicadScript) {
    ...
    server.tool("import_svg_logo", "Imports an SVG file as filled graphic polygons onto a KiCAD PCB layer (default F.SilkS / front silkscreen). Curves are linearised automatically. Ideal for placing a company or project logo on the board.", {
