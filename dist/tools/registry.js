 ...
 */
export function getRoutedToolNames() {
    const allRoutedTools = [];
    for (const category of toolCategories) {
 ...
 */
export function isRoutedTool(toolName) {
...
export function searchTools(query) {
    ...
    for (const category of toolCategories) {
        const categoryMatch = category.name.toLowerCase().includes(q) || category.description.toLowerCase().includes(q);
        for (const toolName of category.tools) {
