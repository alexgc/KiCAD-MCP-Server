 ...
 */
export function registerLibraryResources(server, callKicadScript) {
    logger.info("Registering library resources");
    // ------------------------------------------------------
    // Component Library Resource
    // ------------------------------------------------------
    server.resource("component_library", new ResourceTemplate("kicad://components/{filter?}/{library?}", {
        list: async () => ({
    ...
    // ------------------------------------------------------
    server.resource("library_component_details", new ResourceTemplate("kicad://library/component/{componentId}/{library?}", {
        list: undefined,
    }), async (uri, params) => {
    ...
    // ------------------------------------------------------
    server.resource("component_footprint", new ResourceTemplate("kicad://footprint/{componentId}/{footprint?}", {
        list: undefined,
    }), async (uri, params) => {
    ...
    // ------------------------------------------------------
    server.resource("component_symbol", new ResourceTemplate("kicad://symbol/{componentId}", {
        list: undefined,
    }), async (uri, params) => {
    ...
    // ------------------------------------------------------
    server.resource("component_3d_model", new ResourceTemplate("kicad://3d-model/{componentId}/{footprint?}", {
        list: undefined,
    }), async (uri, params) => {
        const { componentId, footprint } = params;
