...
export class KiCADMcpServer {
     ...
     */
    constructor(kicadScriptPath, logLevel = "info") {
     ...
     */
    async validatePrerequisites(pythonExe) {
        const isWindows = process.platform === "win32";
    ...
    tryParseResponse() {
        ...
        try {
            ...
            if (preambleLines.length > 0) {
                logger.warn(`Stripped non-JSON preamble from Python response: ${preambleLines.join(" | ")}`);
            }
        }
