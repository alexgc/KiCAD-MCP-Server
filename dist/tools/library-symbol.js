 ...
 */
import { z } from "zod";
export function registerSymbolLibraryTools(server, callKicadScript) {
    // List available symbol libraries
    server.tool("list_symbol_libraries", "List all available KiCAD symbol libraries from global sym-lib-table", {}, async () => {
    ...
    server.tool("search_symbols", `Search for symbols in local KiCAD symbol libraries.
...
Returns symbol references that can be used directly in schematics.`, {
    ...
    server.tool("list_library_symbols", "List all symbols in a specific KiCAD symbol library", {
    ...
    server.tool("get_symbol_info", "Get detailed information about a specific symbol", {
        symbol: z
            .string()
...
//# sourceMappingURL=library-symbol.js.map