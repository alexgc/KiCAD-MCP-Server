 ...
 */
export function registerBoardResources(server, callKicadScript) {
    ...
    // ------------------------------------------------------
    server.resource("board_extents", new ResourceTemplate("kicad://board/extents/{unit?}", {
        list: async () => ({
            resources: [
    ...
    // ------------------------------------------------------
    server.resource("board_2d_view", new ResourceTemplate("kicad://board/2d-view/{format?}", {
        list: async () => ({
            resources: [
    ...
    // ------------------------------------------------------
    server.resource("board_3d_view", new ResourceTemplate("kicad://board/3d-view/{angle?}", {
        list: async () => ({
            resources: [
