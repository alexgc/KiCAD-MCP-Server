 ...
 */
export function createJsonResponse(data, uri) {
    return {
        contents: [
            {
 ...
 * @returns MCP resource response object
 */
export function createBinaryResponse(data, mimeType, uri) {
 ...
 */
export function createErrorResponse(error, details, uri) {
    return {
        contents: [
            {
                uri: uri || "data:application/json",
