...
export function registerExportTools(server, callKicadScript) {
    ...
    // Export Netlist Tool
    // ------------------------------------------------------
    server.tool("export_netlist", "Export the schematic netlist to a file using kicad-cli. Supports KiCad XML (default), Spice (for simulation), Cadstar, and OrcadPCB2 formats. Use this when you need to write a netlist file to disk — for example to produce a SPICE file for simulation or to diff against a reference. To get net/component data inline without writing a file, use generate_netlist instead.", {
    ...
    // ------------------------------------------------------
    server.tool("export_position_file", {
