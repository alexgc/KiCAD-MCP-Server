...
export function registerComponentTools(server, callKicadScript) {
    ...
    // ------------------------------------------------------
    server.tool("load_footprints", "Load footprints directly onto the board using absolute .pretty library paths. " +
    ...
    // ------------------------------------------------------
    server.tool("add_component_annotation", {
        reference: z.string().describe("Reference designator of the component (e.g., 'R5')"),
    ...
    // ------------------------------------------------------
    server.tool("get_component_pads", {
    ...
    }, async ({ componentId, startPosition, rows, columns, rowSpacing, columnSpacing, startReference, footprint, value, rotation, }) => {
