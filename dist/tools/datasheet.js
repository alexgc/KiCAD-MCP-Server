 ...
 */
import { z } from "zod";
export function registerDatasheetTools(server, callKicadScript) {
    // ── enrich_datasheets ──────────────────────────────────────────────────────
    server.tool("enrich_datasheets", `Fill in missing Datasheet URLs in a KiCAD schematic using LCSC part numbers.
...
Use dry_run=true to preview changes without writing.`, {
    ...
    // ── get_datasheet_url ──────────────────────────────────────────────────────
    server.tool("get_datasheet_url", `Get the LCSC datasheet URL for a component by LCSC number.
