 ...
 */
export function registerComponentResources(server, callKicadScript) {
    ...
    // ------------------------------------------------------
    server.resource("component_details", new ResourceTemplate("kicad://component/{reference}/details", {
        list: undefined,
    }), async (uri, params) => {
    ...
    // ------------------------------------------------------
    server.resource("component_connections", new ResourceTemplate("kicad://component/{reference}/connections", {
        list: undefined,
    }), async (uri, params) => {
        const { reference } = params;
    ...
    // ------------------------------------------------------
    server.resource("component_visualization", new ResourceTemplate("kicad://component/{reference}/visualization", {
        list: undefined,
    }), async (uri, params) => {
        const { reference } = params;
